...
class JoinTest {
    ...
    void joinSuccess() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/join")
                ...
                .andExpect(MockMvcResultMatchers.content().string("회원가입이 정상적으로 처리 되었습니다."));
    ...
    void joinIsValidEmail() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/join")
                ...
                .andExpect(MockMvcResultMatchers.content().string("이메일 형식을 확인해주세요."));
    ...
    void joinIsValidPassword() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/join")
                ...
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.content().string("비밀번호는 8자리 이상이어야 합니다."));
